    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <header className="bg-[#1a1a2e] text-white px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <button onClick={() => navigate("/pos/reports")} className={`px-3 py-1.5 rounded text-xs font-medium flex items-center gap-1 ${location.pathname === "/pos/reports" ? "bg-red-600" : "text-gray-300 hover:bg-white/10"}`}><BarChart3 className="w-3 h-3" /> Reports</button>
